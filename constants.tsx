...
export const UI_STRINGS: Record<Language, any> = {
  en: {
    ...
    iam: 'I am',
    heroDesc: '24-year-old computer science graduate specialized in Intelligent Models and Decision-making. Passionate about building software that solves complex problems.',
  ...
  fr: {
    ...
    iam: 'Je suis',
    heroDesc: 'Diplômé en informatique de 24 ans spécialisé dans les Modèles Intelligents et la Décision. Passionné par le développement de logiciels résolvant des problèmes complexes.',
  ...
  ar: {
    ...
    iam: 'أنا',
    heroDesc: 'خريج في الإعلام الآلي، متخصص في النماذج الذكية وأنظمة اتخاذ القرار. أسعى لتطوير حلول برمجية مبتكرة لمواجهة التحديات التقنية المعقدة.',
